...
public class SettingsActivity extends AppCompatActivity {
    ...
    SharedPreferences sp; //to save the state of the switch
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //if enabled check switch, otherwise uncheck switch - by default it's unchecked/false
        if (isPostEnabled){
    ...
    private void unsubscribePostNotifications() {
        //unsubscribe to a topic(POST) to disable it's notifs
    ...
    private void subscribePostNotifications() {
        //subscribe to a topic(POST) to disable it's notifs
