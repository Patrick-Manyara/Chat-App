...
public class FirebaseMessaging extends FirebaseMessagingService {
            ...
            if (fUser !=null && sent.equals(fUser.getUid())){
                if (!savedCurrentUser.equals(user)){
                    if (Build.VERSION.SDK_INT >=Build.VERSION_CODES.O){
                        ...
                        sendNormalNofification(remoteMessage);
                    }
    ...
    PendingIntent pendingIntent = PendingIntent.getActivity(this, 0, intent, PendingIntent.FLAG_ONE_SHOT);
        ...
        Bitmap largeIcon = BitmapFactory.decodeResource(getResources(), R.drawable.chattrylogo);

        Uri notificationSoundUri = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION);
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this, "" + ADMIN_CHANNEL_ID)
                .setSmallIcon(R.drawable.chattrylogo)
    ...
    private void sendNormalNofification(RemoteMessage remoteMessage) {
        String user=remoteMessage.getData().get("user");
    ...
    private void sendOAndAboveNotification(RemoteMessage remoteMessage) {
        ...
        Notification.Builder builder=notification1.getNotifications(icon, title, pIntent, defSoundUri, body);
